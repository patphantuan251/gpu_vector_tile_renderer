...
const highp vec4 color = vec4(0.8627450980392157, 1.0, 0.7607843137254902, 1.0);
const highp vec2 translate = vec2(0, 0);

void main() {
highp float opacity = data_interpolate(opacity_start_value, opacity_end_value, stadium_ubo.opacity_start_stop, stadium_ubo.opacity_end_stop);
v_opacity = opacity;
