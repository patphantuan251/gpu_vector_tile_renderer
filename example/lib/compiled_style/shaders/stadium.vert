...
const highp vec4 color = vec4(0.15600000000000003, 0.23959999999999998, 0.244, 1.0);
const highp vec2 translate = vec2(0, 0);

void main() {
  highp float opacity = data_interpolate(opacity_start_value, opacity_end_value, stadium_ubo.opacity_stops.x, stadium_ubo.opacity_stops.y);
  v_opacity = opacity;
