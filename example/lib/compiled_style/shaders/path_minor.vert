...
const highp vec4 color = vec4(0.45, 0.45, 0.45, 1.0);
...
void main() {
  float width = data_interpolate(width_start_value, width_end_value, path_minor_ubo.width_stops.x, path_minor_ubo.width_stops.y);
  v_width = width;
  vec2 dasharray_size = path_minor_ubo.dasharray_size;
