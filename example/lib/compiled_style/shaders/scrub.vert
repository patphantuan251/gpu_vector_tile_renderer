...
const highp vec4 color = vec4(0.7764705882352941, 0.9019607843137255, 0.6980392156862745, 1.0);
const highp vec2 translate = vec2(0, 0);

void main() {
highp float opacity = data_interpolate(opacity_start_value, opacity_end_value, scrub_ubo.opacity_start_stop, scrub_ubo.opacity_end_stop);
v_opacity = opacity;
