...
const highp vec4 color = vec4(0.63, 0.63, 0.63, 1.0);
...
void main() {
  float width = data_interpolate(width_start_value, width_end_value, footway_tunnel_ubo.width_stops.x, footway_tunnel_ubo.width_stops.y);
  v_width = width;
  vec2 dasharray_size = footway_tunnel_ubo.dasharray_size;
