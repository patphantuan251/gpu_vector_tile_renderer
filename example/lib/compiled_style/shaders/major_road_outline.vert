...
const highp vec4 color = vec4(0.3376, 0.5078399999999998, 0.7024, 1.0);
...
void main() {
  float width = data_interpolate(width_start_value, width_end_value, major_road_outline_ubo.width_stops.x, major_road_outline_ubo.width_stops.y);
  v_width = width;
