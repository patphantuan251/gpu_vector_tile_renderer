...
void main() {
  v_color = color;
  float width = data_interpolate(width_start_value, width_end_value, road_under_construction_ubo.width_stops.x, road_under_construction_ubo.width_stops.y);
  v_width = width;
  vec2 dasharray_size = road_under_construction_ubo.dasharray_size;
