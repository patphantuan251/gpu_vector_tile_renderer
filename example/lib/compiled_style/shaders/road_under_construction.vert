...
void main() {
v_color = color;
float width = data_interpolate(width_start_value, width_end_value, road_under_construction_ubo.width_start_stop, road_under_construction_ubo.width_end_stop);
v_width = width;
