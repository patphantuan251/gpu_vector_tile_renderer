...
const highp vec4 color = vec4(0.23010000000000008, 0.3846699999999999, 0.5498999999999999, 1.0);
...
void main() {
  float width = data_interpolate(width_start_value, width_end_value, highway_outline_ubo.width_stops.x, highway_outline_ubo.width_stops.y);
  v_width = width;
