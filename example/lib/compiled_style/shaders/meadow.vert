...
const highp vec4 color = vec4(0.10339999999999999, 0.2666399999999999, 0.3366, 1.0);
const highp vec2 translate = vec2(0, 0);

void main() {
  highp float opacity = data_interpolate(opacity_start_value, opacity_end_value, meadow_ubo.opacity_stops.x, meadow_ubo.opacity_stops.y);
  v_opacity = opacity;
