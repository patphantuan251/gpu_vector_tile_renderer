...
const highp vec4 color = vec4(0.8901960784313725, 0.9254901960784314, 0.7725490196078432, 1.0);
const highp vec2 translate = vec2(0, 0);

void main() {
highp float opacity = data_interpolate(opacity_start_value, opacity_end_value, meadow_ubo.opacity_start_stop, meadow_ubo.opacity_end_stop);
v_opacity = opacity;
