...
const highp vec4 color = vec4(0.09239999999999998, 0.2570399999999999, 0.3276, 1.0);
const highp vec2 translate = vec2(0, 0);

void main() {
  highp float opacity = data_interpolate(opacity_start_value, opacity_end_value, forest_ubo.opacity_stops.x, forest_ubo.opacity_stops.y);
  v_opacity = opacity;
