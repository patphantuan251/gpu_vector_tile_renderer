...
const highp vec4 color = vec4(0.6705882352941176, 0.8509803921568627, 0.6705882352941176, 1.0);
const highp vec2 translate = vec2(0, 0);

void main() {
highp float opacity = data_interpolate(opacity_start_value, opacity_end_value, forest_ubo.opacity_start_stop, forest_ubo.opacity_end_stop);
v_opacity = opacity;
