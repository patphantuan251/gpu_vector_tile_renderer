...
const highp vec4 color = vec4(0.18, 0.18, 0.18, 1.0);
...
void main() {
  float width = data_interpolate(width_start_value, width_end_value, minor_road_outline_ubo.width_stops.x, minor_road_outline_ubo.width_stops.y);
  v_width = width;
