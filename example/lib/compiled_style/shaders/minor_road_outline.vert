...
uniform MinorRoadOutlineUbo {
  float width_start_stop;
  float width_end_stop;
} minor_road_outline_ubo;
...
const highp vec4 color = vec4(0.8117647058823529, 0.803921568627451, 0.788235294117647, 1.0);
...
void main() {
float width = data_interpolate(width_start_value, width_end_value, minor_road_outline_ubo.width_start_stop, minor_road_outline_ubo.width_end_stop);
v_width = width;
