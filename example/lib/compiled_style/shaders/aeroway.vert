...
const highp vec4 color = vec4(0.17280000000000006, 0.25056, 0.36719999999999997, 1.0);
...
void main() {
  float width = data_interpolate(width_start_value, width_end_value, aeroway_ubo.width_stops.x, aeroway_ubo.width_stops.y);
  v_width = width;
