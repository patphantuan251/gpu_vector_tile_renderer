...
const highp vec4 color = vec4(0.7215686274509804, 0.7215686274509804, 0.7215686274509804, 1.0);
in float opacity;
out float v_opacity;
...
void main() {
v_opacity = opacity;
float width = data_interpolate(width_start_value, width_end_value, major_rail_hatching_ubo.width_start_stop, major_rail_hatching_ubo.width_end_stop);
v_width = width;
