...
void main() {
  float width = data_interpolate(width_start_value, width_end_value, path_ubo.width_stops.x, path_ubo.width_stops.y);
  v_width = width;
  vec2 dasharray_size = path_ubo.dasharray_size;
