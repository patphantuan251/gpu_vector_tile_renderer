...
const highp vec4 color = vec4(0.788235294117647, 0.788235294117647, 0.788235294117647, 1.0);
...
void main() {
float width = data_interpolate(width_start_value, width_end_value, path_ubo.width_start_stop, path_ubo.width_end_stop);
v_width = width;
