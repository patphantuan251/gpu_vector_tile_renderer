...
const highp vec4 color = vec4(0.10079999999999997, 0.14816, 0.21920000000000003, 1.0);
...
void main() {
  float width = data_interpolate(width_start_value, width_end_value, aqueduct_ubo.width_stops.x, aqueduct_ubo.width_stops.y);
  v_width = width;
