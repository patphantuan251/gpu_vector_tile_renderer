...
const highp vec4 color = vec4(0.5215686274509804, 0.796078431372549, 0.9803921568627451, 1.0);
...
void main() {
float width = data_interpolate(width_start_value, width_end_value, aqueduct_ubo.width_start_stop, aqueduct_ubo.width_end_stop);
v_width = width;
