...
const highp vec4 color = vec4(0.64, 0.64, 0.64, 1.0);
...
void main() {
  float width = data_interpolate(width_start_value, width_end_value, cablecar_dash_ubo.width_stops.x, cablecar_dash_ubo.width_stops.y);
  v_width = width;
  vec2 dasharray_size = cablecar_dash_ubo.dasharray_size;
