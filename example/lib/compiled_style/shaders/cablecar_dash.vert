...
const highp vec4 color = vec4(0.6392156862745098, 0.6392156862745098, 0.6392156862745098, 1.0);
...
void main() {
float width = data_interpolate(width_start_value, width_end_value, cablecar_dash_ubo.width_start_stop, cablecar_dash_ubo.width_end_stop);
v_width = width;
