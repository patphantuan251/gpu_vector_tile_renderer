...
const highp vec4 color = vec4(0.9764705882352941, 0.9176470588235294, 0.9019607843137255, 1.0);
const highp vec2 translate = vec2(0, 0);

void main() {
highp float opacity = data_interpolate(opacity_start_value, opacity_end_value, hospital_ubo.opacity_start_stop, hospital_ubo.opacity_end_stop);
v_opacity = opacity;
