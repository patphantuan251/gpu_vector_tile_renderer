...
const highp vec4 color = vec4(0.21559999999999999, 0.22, 0.22440000000000002, 1.0);
const highp vec2 translate = vec2(0, 0);

void main() {
  highp float opacity = data_interpolate(opacity_start_value, opacity_end_value, cemetery_ubo.opacity_stops.x, cemetery_ubo.opacity_stops.y);
  v_opacity = opacity;
