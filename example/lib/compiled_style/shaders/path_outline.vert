...
const highp vec4 color = vec4(0.06, 0.06, 0.06, 1.0);
...
void main() {
  float width = data_interpolate(width_start_value, width_end_value, path_outline_ubo.width_stops.x, path_outline_ubo.width_stops.y);
  v_width = width;
