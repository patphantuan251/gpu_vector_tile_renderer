...
void main() {
highp vec4 color = data_interpolate(color_start_value, color_end_value, ferry_line_ubo.color_start_stop, ferry_line_ubo.color_end_stop);
v_color = color;
float opacity = data_interpolate(opacity_start_value, opacity_end_value, ferry_line_ubo.opacity_start_stop, ferry_line_ubo.opacity_end_stop);
v_opacity = opacity;
float width = data_interpolate(width_start_value, width_end_value, ferry_line_ubo.width_start_stop, ferry_line_ubo.width_end_stop);
v_width = width;
