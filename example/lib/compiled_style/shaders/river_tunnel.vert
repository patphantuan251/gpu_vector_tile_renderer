...
const highp vec4 color = vec4(0.6196078431372549, 0.7803921568627451, 0.9411764705882353, 1.0);
...
void main() {
float width = data_interpolate(width_start_value, width_end_value, river_tunnel_ubo.width_start_stop, river_tunnel_ubo.width_end_stop);
v_width = width;
