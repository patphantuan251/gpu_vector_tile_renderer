...
const highp vec4 color = vec4(0.08499999999999996, 0.283, 0.41500000000000004, 1.0);
const highp vec2 translate = vec2(0, 0);

void main() {
  highp float opacity = data_interpolate(opacity_start_value, opacity_end_value, glacier_ubo.opacity_stops.x, glacier_ubo.opacity_stops.y);
  v_opacity = opacity;
