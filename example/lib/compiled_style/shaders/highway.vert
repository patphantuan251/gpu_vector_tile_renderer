...
const highp vec4 color = vec4(1.0, 0.8, 0.5215686274509804, 1.0);
...
void main() {
float width = data_interpolate(width_start_value, width_end_value, highway_ubo.width_start_stop, highway_ubo.width_end_stop);
v_width = width;
