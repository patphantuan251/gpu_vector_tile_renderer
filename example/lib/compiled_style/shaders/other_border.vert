...
const highp vec4 color = vec4(0.4323999999999999, 0.4323999999999999, 0.5076, 1.0);
...
void main() {
  float width = data_interpolate(width_start_value, width_end_value, other_border_ubo.width_stops.x, other_border_ubo.width_stops.y);
  v_width = width;
  vec2 dasharray_size = other_border_ubo.dasharray_size;
