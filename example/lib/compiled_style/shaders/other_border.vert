...
const highp vec4 color = vec4(0.7019607843137254, 0.7019607843137254, 0.7019607843137254, 1.0);
...
void main() {
float width = data_interpolate(width_start_value, width_end_value, other_border_ubo.width_start_stop, other_border_ubo.width_end_stop);
v_width = width;
