...
const highp vec4 color = vec4(0.08960000000000001, 0.12824000000000002, 0.1904, 1.0);
...
void main() {
  float width = data_interpolate(width_start_value, width_end_value, river_ubo.width_stops.x, river_ubo.width_stops.y);
  v_width = width;
