...
const highp vec4 color = vec4(0.5095000000000001, 0.5095000000000001, 0.5905, 1.0);
...
void main() {
  float width = data_interpolate(width_start_value, width_end_value, disputed_border_ubo.width_stops.x, disputed_border_ubo.width_stops.y);
  v_width = width;
  vec2 dasharray_size = disputed_border_ubo.dasharray_size;
