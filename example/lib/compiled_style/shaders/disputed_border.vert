...
const highp vec4 color = vec4(0.6313725490196078, 0.6313725490196078, 0.6313725490196078, 1.0);
...
void main() {
float width = data_interpolate(width_start_value, width_end_value, disputed_border_ubo.width_start_stop, disputed_border_ubo.width_end_stop);
v_width = width;
