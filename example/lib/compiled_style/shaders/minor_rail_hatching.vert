...
uniform MinorRailHatchingUbo {
  vec2 width_stops;
  vec2 dasharray_size;
} minor_rail_hatching_ubo;
...
void main() {
  float width = data_interpolate(width_start_value, width_end_value, minor_rail_hatching_ubo.width_stops.x, minor_rail_hatching_ubo.width_stops.y);
  v_width = width;
  vec2 dasharray_size = minor_rail_hatching_ubo.dasharray_size;
