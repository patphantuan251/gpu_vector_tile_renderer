...
const maptilerStreetsDarkStyle = '''
{
  "version": 8,
  "name": "Streets Dark",
  "metadata": {
  ...
  "sources": {
    ...
    "maptiler_planet": {
      "url": "https://api.maptiler.com/tiles/v3/tiles.json?key=K7fVxcyNwyVR4lSjp6qE",
      "type": "vector"
    }
  },
  "sprite": "https://api.maptiler.com/maps/streets-v2-dark/sprite",
  "glyphs": "https://api.maptiler.com/fonts/{fontstack}/{range}.pbf?key=K7fVxcyNwyVR4lSjp6qE",
  "layers": [
    {
      "id": "Background",
      "type": "background",
    ...
    },
    {
      ...
      "filter": [
        "all",
        ["==", ["geometry-type"], "LineString"],
        ["match", ["get", "class"], ["path_pedestrian"], true, false],
        ["!=", ["get", "brunnel"], "tunnel"]
      ],
      "layout": {
        "line-cap": "butt",
    ...
    },
    {
      ...
      "filter": [
        "all",
        ["match", ["get", "class"], ["golf", "park"], true, false],
        ["has", "name"]
      ],
      "layout": {
        "icon-allow-overlap": false,
    ...
    },
    {
      ...
      "layout": {
        ...
        "text-max-width": 8,
        "text-padding": 2,
        "text-size": ["interpolate", ["linear"], ["zoom"], 3, 8, 5, 9, 6, 10],
        "text-transform": "uppercase",
        "visibility": "visible"
      },
      "paint": {
...
const maptilerTonerStyle = '''
{
  ...
  "layers": [
    ...
    },
    {
      ...
      "paint": {
        "fill-antialias": false,
        "fill-opacity": ["interpolate", ["linear"], ["zoom"], 10, 0.75, 14, 1],
        "fill-pattern": "dash-t"
      }
    },
    {
    ...
    },
    {
      ...
      "layout": {"visibility": "visible"},
      "paint": {"fill-antialias": true, "fill-color": "hsl(0,0%,0%)"}
    },
    {
      "id": "River",
      "type": "line",
    ...
    },
    {
      ...
      "source-layer": "transportation",
      "minzoom": 15,
      "filter": ["==", ["get", "class"], "path_pedestrian"],
      "layout": {
        "line-cap": "round",
        "line-join": "round",
        "visibility": "visible"
    ...
    },
    {
      ...
      "paint": {
        ...
        "line-width": ["interpolate", ["linear"], ["zoom"], 13, 0.85, 17, 2]
      }
    },
    {
      "id": "Railway hatching",
      ...
      "paint": {
        ...
        "line-width": ["interpolate", ["linear"], ["zoom"], 15, 2, 17, 6]
      }
    },
    {
      "id": "Building",
    ...
    },
    {
      ...
      "paint": {
        "line-color": "hsl(0,0%,0%)",
        "line-width": ["interpolate", ["linear"], ["zoom"], 3, 1.2, 7, 3, 22, 6]
      }
    },
    {
      "id": "River labels",
    ...
    },
    {
      ...
      "minzoom": 3,
      "maxzoom": 10,
      "filter": ["all", ["==", ["get", "class"], "sea"], ["has", "name"]],
      "layout": {
        "symbol-placement": "point",
        "symbol-spacing": 350,
        "text-field": ["coalesce", ["get", "name:en"], ["get", "name"]],
    ...
    },
    {
      ...
      "source-layer": "water_name",
      "minzoom": 10,
      "filter": ["all", ["==", ["get", "class"], "lake"], ["has", "name"]],
      "layout": {
        "symbol-placement": "point",
        "symbol-spacing": 350,
        "text-field": ["coalesce", ["get", "name:en"], ["get", "name"]],
    ...
    },
    {
      ...
      "minzoom": 2,
      "maxzoom": 4,
      "filter": ["all", ["==", ["get", "class"], "ocean"], ["has", "name"]],
      "layout": {
        "symbol-placement": "point",
        "symbol-spacing": 350,
        "text-field": ["to-string", ["get", "name:en"]],
    ...
    },
    {
      ...
      "layout": {
        ...
        "text-max-width": 10,
        "text-size": ["interpolate", ["linear"], ["zoom"], 8, 15, 16, 18],
        "visibility": "visible"
      },
      "paint": {
        "text-color": "hsl(0,0%,0%)",
    ...
    },
    {
      ...
      "layout": {
        ...
        "text-max-width": 10,
        "text-padding": 2,
        "text-size": ["interpolate", ["linear"], ["zoom"], 3, 14, 4, 16, 5, 21],
        "text-transform": "none",
        "visibility": "visible"
      },
      "paint": {
    ...
    },
    {
      ...
      "layout": {
        ...
        "text-max-width": 10,
        "text-size": ["interpolate", ["linear"], ["zoom"], 3, 18, 4, 24],
        "text-transform": "uppercase",
        "visibility": "visible"
      },
      "paint": {
