...
const generatedLocation = path.resolve(rootLocation, 'lib', 'src', 'tilejson', 'gen', 'tilejson.gen.dart');

const referenceFolder = path.resolve(rootLocation, 'lib', 'src', 'tilejson', 'reference');
