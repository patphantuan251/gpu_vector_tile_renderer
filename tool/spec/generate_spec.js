...
const generatedLocation = path.resolve(rootLocation, 'lib', 'src', 'spec', 'gen', 'style.gen.dart');

const reference = require(path.resolve(rootLocation, 'lib', 'src', 'spec', 'reference', 'v8.json'));
...
const generateDartCode = () => {
  ...
  code.push(`// Generated by tool/spec/generate_spec.js`);

  code.push('');
  code.push(`import 'package:equatable/equatable.dart';`);
  code.push(`import 'package:gpu_vector_tile_renderer/_spec.dart';`);
  code.push('');
