...
@ffi.DefaultAsset('package:gpu_vector_tile_renderer/gpu_vector_tile_renderer')
library;

import 'dart:ffi' as ffi;

@ffi.Native<ffi.Pointer<tessellation_result> Function(ffi.Pointer<polygon>)>()
external ffi.Pointer<tessellation_result> tessellate_polygon(
  ffi.Pointer<polygon> poly,
);

@ffi.Native<ffi.Void Function(ffi.Pointer<tessellation_result>)>()
external void free_tessellation_result(
  ffi.Pointer<tessellation_result> result,
);
...
final class ring extends ffi.Struct {
...
final class polygon extends ffi.Struct {
  external ring exterior;

  external ffi.Pointer<ring> interiors;

  @ffi.Uint32()
  external int interior_count;
}

final class tessellation_result extends ffi.Struct {
