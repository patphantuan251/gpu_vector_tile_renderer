...
abstract class Property<T> with EquatableMixin {
  const Property({required this.isExpression, this.value, this.expression, this.defaultValue});

  const Property.value(this.value, {this.defaultValue}) : expression = null, isExpression = false;

  const Property.expression(this.expression, {this.defaultValue}) : value = null, isExpression = true;
