...
enum _ColorInterpolationMode { rgb, hcl, lab }
...
T _interpolateExpressionImpl<T>(
  ...
  final t = _interpolationFactor(options, value, stops[index].$1, stops[index + 1].$1);
...
int _findStopLessThanOrEqualTo(List<num> stops, num input) {
...
Color _interpolateColor(Color a, Color b, num t) {
  final list = _interpolateNumberList(a.asRgbaList, b.asRgbaList, t);
