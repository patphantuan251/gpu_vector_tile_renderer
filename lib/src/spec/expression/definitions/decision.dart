...
T coalesceExpressionImpl<T>(EvaluationContext context, List<Expression<T>> expressions) {
...
bool lessThanExpressionImpl(
  ...
  return !greaterThanExpressionImpl(context, left, right, collator) &&
      !equalsExpressionImpl(context, left, right, collator);
}
...
bool allExpressionImpl(EvaluationContext context, List<Expression<bool>> expressions) {
  for (final expression in expressions) {
...
bool anyExpressionImpl(EvaluationContext context, List<Expression<bool>> expressions) {
  for (final expression in expressions) {
    if (expression(context)) {
      return true;
    }
...
bool notExpressionImpl(EvaluationContext context, Expression<bool> expression) {
