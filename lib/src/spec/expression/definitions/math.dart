...
num minusExpressionImpl(EvaluationContext context, Expression<num> left, Expression<num>? right) {
  if (right == null) {
    return -left(context);
  }
...
num divideExpressionImpl(EvaluationContext context, Expression<num> left, Expression<num> right) {
  return left(context) / right(context);
}

@ExpressionAnnotation('ModExpression', rawName: '%')
num modExpressionImpl(EvaluationContext context, Expression<num> left, Expression<num> right) {
  return left(context) % right(context);
}

@ExpressionAnnotation('PowExpression', rawName: '^')
num powExpressionImpl(EvaluationContext context, Expression<num> base, Expression<num> exponent) {
  return math.pow(base(context), exponent(context));
}

@ExpressionAnnotation('SqrtExpression', rawName: 'sqrt')
num sqrtExpressionImpl(EvaluationContext context, Expression<num> value) {
  return math.sqrt(value(context));
}

@ExpressionAnnotation('Log10Expression', rawName: 'log10')
num log10ExpressionImpl(EvaluationContext context, Expression<num> value) {
  return math.log(value(context)) / math.ln10;
}

@ExpressionAnnotation('LnExpression', rawName: 'ln')
num lnExpressionImpl(EvaluationContext context, Expression<num> value) {
  return math.log(value(context));
}

@ExpressionAnnotation('Log2Expression', rawName: 'log2')
num log2ExpressionImpl(EvaluationContext context, Expression<num> value) {
  return math.log(value(context)) / math.ln2;
}

@ExpressionAnnotation('SinExpression', rawName: 'sin')
num sinExpressionImpl(EvaluationContext context, Expression<num> value) {
  return math.sin(value(context));
}

@ExpressionAnnotation('CosExpression', rawName: 'cos')
num cosExpressionImpl(EvaluationContext context, Expression<num> value) {
  return math.cos(value(context));
}

@ExpressionAnnotation('TanExpression', rawName: 'tan')
num tanExpressionImpl(EvaluationContext context, Expression<num> value) {
  return math.tan(value(context));
}

@ExpressionAnnotation('AsinExpression', rawName: 'asin')
num asinExpressionImpl(EvaluationContext context, Expression<num> value) {
  return math.asin(value(context));
}

@ExpressionAnnotation('AcosExpression', rawName: 'acos')
num acosExpressionImpl(EvaluationContext context, Expression<num> value) {
  return math.acos(value(context));
}

@ExpressionAnnotation('AtanExpression', rawName: 'atan')
num atanExpressionImpl(EvaluationContext context, Expression<num> value) {
  return math.atan(value(context));
}

@ExpressionAnnotation('MinExpression', rawName: 'min')
num minExpressionImpl(EvaluationContext context, List<Expression<num>> args) {
  return args.map((e) => e(context)).reduce(math.min);
}

@ExpressionAnnotation('MaxExpression', rawName: 'max')
num maxExpressionImpl(EvaluationContext context, List<Expression<num>> args) {
  return args.map((e) => e(context)).reduce(math.max);
}

@ExpressionAnnotation('AbsExpression', rawName: 'abs')
num absExpressionImpl(EvaluationContext context, Expression<num> value) {
  return value(context).abs();
}

@ExpressionAnnotation('RoundExpression', rawName: 'round')
num roundExpressionImpl(EvaluationContext context, Expression<num> value) {
  return value(context).round();
}

@ExpressionAnnotation('CeilExpression', rawName: 'ceil')
num ceilExpressionImpl(EvaluationContext context, Expression<num> value) {
  return value(context).ceilToDouble();
}

@ExpressionAnnotation('FloorExpression', rawName: 'floor')
num floorExpressionImpl(EvaluationContext context, Expression<num> value) {
